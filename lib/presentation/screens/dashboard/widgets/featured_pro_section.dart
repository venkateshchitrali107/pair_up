...
class FeaturedProSection extends StatelessWidget {
  final List<ProPlayer> featuredPlayers;
  final VoidCallback? onSeeAllTap;

  const FeaturedProSection({
    super.key,
    required this.featuredPlayers,
    this.onSeeAllTap,
  });
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return FeaturedProCard(
                player: player,
                onTap: () {
                  debugPrint('Tapped on featured pro: ${player.name}');
                },
              );
            },
          ),
